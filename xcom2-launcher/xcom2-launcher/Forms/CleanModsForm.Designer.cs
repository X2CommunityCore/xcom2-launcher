namespace XCOM2Launcher.Forms
{
    partial class CleanModsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.shadercache_empty_radiobutton, "安全");
            ...
            this.toolTip1.SetToolTip(this.source_groupbox, "即每个MOD下的Src文件夹\r\n这些源文件是自动生成的,只对MOD作者有用");
            // 
            // src_all_radiobutton
            // 
            ...
            this.toolTip1.SetToolTip(this.src_xcomgame_radiobutton, "只删除src/XComGame文件(一般为模型)");
